...
## Personal Mac
### Install Python 3.12
First check whether Python 3.12 is already installed by running
```bash
python3.12 -V
```
...
While the virtual environment is active, you can call `python3.12` directly with `python` because that is the only python version that is linked in the virtual environment.
